...
def view_names() :
  with open('produits.csv', 'r') as file : # Ouvre notre liste de produit avec le mode read 
...
def next_id() : 
  with open('produits.csv','r',newline='') as file : # Ouvre notre liste de produit avec le mode read
